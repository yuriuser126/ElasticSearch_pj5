...
const SearchInput: React.FC<SearchInputProps> = ({
  onSearch,
  loading = false,
  placeholder = "기술 키워드로 오픈 데이터를 검색하세요...",
  className = "",
}) => {
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full pl-12 pr-20 py-4 text-lg border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 focus:outline-none shadow-sm transition-all duration-200"
            disabled={loading}
          />
